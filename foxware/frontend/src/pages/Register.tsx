    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-20">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-xl border border-[var(--border-primary)] bg-[var(--bg-card)] p-8">
          ...
          <p className="text-sm text-[var(--text-muted)] mb-6">Start controlling your devices</p>
          ...
          <p className="mt-6 text-center text-sm text-[var(--text-muted)]">
            ...
            <Link to="/login" className="text-[var(--accent)] hover:opacity-80 font-medium transition-opacity">
              Sign in
            </Link>
          </p>
        </div>
